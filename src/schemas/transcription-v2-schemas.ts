...
export const getTranscriptionV2ParamsSchema = z.object({
  id: z.string(),
});

export const getTranscriptionV2ResponseSchema = z.object({
  transcription: transcriptionV2Schema,
});
...
export const getTranscriptionV2Schema = {
  tags: ["transcription"],
  summary: "Get a transcription V2",
  description: "Returns a single transcription by its ID.",
  params: getTranscriptionV2ParamsSchema,
  response: {
    200: getTranscriptionV2ResponseSchema,
    404: errorSchema,
    500: errorSchema,
  },
};
